...
export default function ButtonConnect() {
    ...
    return (
        <button type={`button`}>
        {/* onClick={() => open()} className={`${state.open && "bg-accent text-background"} group border border-accent rounded-xl text-center cursor-pointer font-bold hover:bg-accent hover:border-none hover:text-white`}> */}
            {/* {state.loading ? (
